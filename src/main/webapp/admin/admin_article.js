...
function loadArticle(){
    ...
    $("#tArticleList").jqGrid({
        ...
        rowNum: 5,
        rowList: [5, 10, 15],
        colNames: ['教师','类型','论文名称', '发表时间', '刊物名称', '刊物级别', '刊物刊号','页码','期数','作者排名（1为第一作者）','是否为通讯作者','附件','备注'],//'状态','操作'
        colModel: [
            {
                name: 'uname',
                index: 'uname',
            ...
            //     align:"center",
            //     formatter:function (cellvalue, options, row) {
            //         return '<a href="#" onclick="passArticle(' + row.id + ')">通过</a>&nbsp;&nbsp;';
            //     }
            // }
        ],
        sortname: 'postTime',
...
function loadCopyRight(){
    ...
    $("#tCopyRightList").jqGrid({
        ...
        rowNum: 5,
        rowList: [5, 10, 15],
        colNames: ['教师','作者姓名', '标题', 'ISSBN','专著/教材/译著/其他','出版社','出版时间','著作号','其他参与者','备注'],//,'状态','操作'
        colModel: [
            {
                name: 'name',
                index: 'name',
            ...
            //     align:"center",
            //     formatter:function (cellvalue, options, row) {
            //         return '<a href="#" onclick="passCopyRight(' + row.id + ')">通过</a>&nbsp;&nbsp;';
            //     }
            // }
        ],
