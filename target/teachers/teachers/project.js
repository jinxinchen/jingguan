        ...
        colModel: [
            ...
            },
            {
                ...
                editoptions: {
                    ...
                    buildSelect: function (responseData) {
                        ...
                        selectHtml += '<option value="省部">' + "省部" + '</option>';
                        selectHtml += '<option value="市厅">' + "市厅" + '</option>';
...

            {
                ...
                formatter:function (cellvalue, options, row) {
                    return '<a href="#" onclick="findMembers(' + row.id + ')"> 查看成员  </a>&nbsp;&nbsp;';
                },
            },
            {
                name:'grants',
...
function uploadEndFile(rowid){
    ...
    urlValue=uploadSever+'uploadProject/uploadEnd.do';
    console.log(rowid)
...
function uploadCreateFile(rowid){
   //'/teachers/teacher/project/uploadCreate.do'
    urlValue=uploadSever+'uploadProject/uploadCreate.do';
    console.log(rowid)
    var rowData=$("#tRewardList").jqGrid("getRowData");
    recordid=rowid;
    //清空form弹窗内内容
